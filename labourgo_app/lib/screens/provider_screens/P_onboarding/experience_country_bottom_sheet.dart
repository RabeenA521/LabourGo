...
const List<Map<String, dynamic>> _cities = [
  {'label': 'Karachi', 'icon': Icons.location_city_rounded, 'tag': 'Sindh'},
  {'label': 'Lahore', 'icon': Icons.location_city_rounded, 'tag': 'Punjab'},
  {'label': 'Islamabad', 'icon': Icons.account_balance_rounded, 'tag': 'Capital'},
  {'label': 'Rawalpindi', 'icon': Icons.location_city_rounded, 'tag': 'Punjab'},
  {'label': 'Faisalabad', 'icon': Icons.location_city_rounded, 'tag': 'Punjab'},
  {'label': 'Multan', 'icon': Icons.location_city_rounded, 'tag': 'Punjab'},
  {'label': 'Peshawar', 'icon': Icons.location_city_rounded, 'tag': 'KPK'},
  {'label': 'Quetta', 'icon': Icons.location_city_rounded, 'tag': 'Balochistan'},
];
            ...
            child: _filtered.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected = _selected == city['label'];

                      return GestureDetector(
                        onTap: () {
                          setState(() => _selected = city['label'] as String);
                          Future.delayed(
                            const Duration(milliseconds: 180),
                            () => Navigator.pop(context, city['label'] as String),
                          );
                        },
