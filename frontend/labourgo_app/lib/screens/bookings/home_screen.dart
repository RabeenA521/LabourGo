              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Clipboard.setData(
                          const ClipboardData(text: 'LABOURGO'));
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFF5CE1E6), Color(0xFF4682B4)],
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  final created = await Navigator.push<bool>(
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) =>
                                          CreateBookingScreen(category: cat),
                                    ),
                                  );
                                  if (!mounted) return;
                                  if (created == true) {
